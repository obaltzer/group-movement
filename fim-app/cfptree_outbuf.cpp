...
void CTreeOutBufManager::Init(int nstack_size)
{
	...
	mfpcfp_file = fopen(goparameters.tree_filename, "wb");
	if(mfpcfp_file==NULL)
	{
	...
	mfpread_file = fopen(goparameters.tree_filename, "rb");
...
//
//--------------------------------------------------------------------------------------
void CTreeOutBufManager::WriteLeafNode(int *pitems, int num_of_items, int nsupport, int hash_bitmap)
{
	ENTRY cfp_entry;
...
//-----------------------------------------------------------------------------------------
void CTreeOutBufManager::InsertCommonPrefixNode(int level, int *pitems, int num_of_items, int nsupport, int hash_bitmap)
{
	int node_size, norig_end_pos;
	ENTRY *pcfp_entry;
	CFP_NODE *pcfp_node;
